...
public class EncapsuleTest {
	...
	public static void main(String[] args) {
		...
		// 초기화 - 은닉된 속성 멤버변수는 생성자(Constructor)로 초기화
		// sonata.name = "소나타";
		// sonata.color = "흰색";
		// sonata.speed = 0;
		...
		// Account 객체 생성과 초기화(우리은행, 101-11-1001, 김유진,10000)
		// 출력 30000

		// 이름을 김유신 -> 김유진
		
		
		Account kb = new Account("우리은행","101-11-1001","김유신",10000);
		kb.deposit(40000);
		kb.withdraw(20000);
		kb.setName("김유진");
		kb.show();
		...
		// Account 객체 생성과 초기화(우리은행, 101-11-1001, 김춘추,30000)
		// 출력 50000
		// 은행명 수정 우리은행 -> 너희은행
		
		Account wr = new Account("너희은행","101-11-1001","김춘추",30000);
		wr.deposit(40000);
		wr.withdraw(20000);
