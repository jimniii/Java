...
public class StringTest {
	public static void main(String[] args) {
		...
		// 문자열 추출
		char c1 = message.charAt(0); // 0번쨰 문자 추출
		char c2 = message.charAt(6); // 6번째 문자 추출 
		...
		// 문자열 인덱스
		int idx1 = message.indexOf('e'); // 첫번째 o		 // 문자열의 앞에서부터 문자 e 탐색
		int idx2 = message.lastIndexOf('e'); // 마지막 o  // 문자열의 뒤에서부터 문자 e 탐색
		...
		String s2 = var2+""; // 빈 문자열 가지고 변환!
		String s3 = ""+var3; // 이걸 제일 많이 쓴다 !! 
